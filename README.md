...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-edabp-0.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-edabp-0.containers.anotherwebservice.com/
...
```
git clone git@github.com:DShacker01/container-edabp-0.git
cd container-edabp-0
```
...
```
docker attach container-edabp-0
```
